...
const reviews = [
  {
    name: "Meera Nair",
    detail: "Verified buyer · Bengaluru",
    rating: 5,
    quote:
      "The chrome finish looks even better in person. I bought them for the design, but the sound has genuinely surprised me too.",
  },
  {
    name: "Kabir Shah",
    ...
    rating: 4,
    quote:
      "The vocals are clear and the bass has enough punch without becoming muddy. I use them every day for calls and music.",
  },
  {
    name: "Sana Verma",
    detail: "Verified buyer · Hyderabad",
    rating: 5,
    quote:
      "They catch the light nicely and feel comfortable on my commute. The cable also feels more solid than I expected.",
  },
  {
    name: "Vikram Joshi",
    ...
    rating: 4,
    quote:
      "I wanted something simple that works without charging. They sound clean and are easy to use every day.",
  },
];
            ...
            <figure key={review.name} className="py-4 first:pt-5 last:pb-5">
              ...
              <figcaption className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs">
                ...
                <span className="inline-flex items-center gap-1 text-muted-foreground">
                  <BadgeCheck className="h-3.5 w-3.5 text-emerald-600" /> Verified purchase
                </span>
              </figcaption>
            </figure>
          ))}
