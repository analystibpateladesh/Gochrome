...
export const STAGE_MESSAGES: Record<StageKey, { title: string; body: string }> = {
  confirmed: {
    ...
    body:
      "Your order {orderId} is confirmed and being packed. We'll ship it within 1–2 days. You'll get a dispatch update on WhatsApp & email as soon as it moves.",
  },
  packed: {
    title: "Packed 📦",
    body:
      "Your order {orderId} has been packed and is ready for dispatch. You'll receive an update on WhatsApp & email once it's on its way.",
  },
  dispatched: {
    title: "Dispatched 📦",
    body:
      "Your order {orderId} has been dispatched from our warehouse! Your courier partner will share a  pinpoint live tracking link on WhatsApp and email shortly - when your order will get shipped.",
  },
  shipped: {
    title: "On the way 🚚",
    body:
      "Your order {orderId} is on its way (Shipped) and should arrive in about 5–6 days. You can track it live using the link sent to your WhatsApp & email by our delivery partner.",
  },
  delivered: {
    title: "Delivered 🎧",
    body:
      "Your order {orderId} was delivered. Hope you're enjoying your Chrome Earphones! If anything's wrong with the product, tap \"Something else\" below to raise a return/replacement request.",
  },
  cancelled: {
    title: "Order Cancelled",
    body:
      "Order {orderId} shows as cancelled/refunded in our system. If this looks wrong or you'd like help, tap \"Something else\" and we'll get a human to check.",
  },
  undelivered: {
    title: "Checking...",
    body:
      "We found order {orderId} but couldn't read its current stage. Tap \"Something else\" and our team will confirm manually.",
  },
};
