...
function Contact() {
  ...
  const submit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast.error("Message could not be sent. Please email gochromeaudio@gmail.com.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <PageHeader eyebrow="Contact" title="Talk to us." sub="gochromeaudio@gmail.com · +91 9140579643" />
