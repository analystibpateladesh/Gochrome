  ...
  head: () => ({
    meta: [
      { title: "GoChrome — Precision Sound. Engineered Chrome." },
      {
        name: "description",
        content:
          "Discover GoChrome Chrome Earphones — reference-grade sound with mirror-polished chrome styling.",
      },
...
const reviews = [
  {
    n: "Meera Nair",
    t: "Verified buyer · Bengaluru",
    q: "The chrome finish looks even better in person. I bought them for the design, but the sound has genuinely surprised me too.",
    r: 5,
  },
  {
    n: "Kabir Shah",
    t: "Verified buyer · Mumbai",
    q: "The vocals are clear and the bass has enough punch without becoming muddy. I use them every day for calls and music.",
    r: 4,
  },
  {
    n: "Sana Verma",
    t: "Verified buyer · Hyderabad",
    q: "They catch the light nicely and feel comfortable on my commute. The cable also feels more solid than I expected.",
    r: 5,
  },
  {
    n: "Vikram Joshi",
    t: "Verified buyer · Pune",
    q: "I wanted something simple that works without charging. They sound clean and are easy to use every day.",
    r: 4,
  },
];
...
const faqs = [
  {
    ...
    a: "Yes. They deliver clear vocals, deep bass, and crisp sound that makes music, movies, and calls feel immersive.",
  },
  {
    q: "What comes in the box?",
    a: "You will receive one pair of chrome wired Type-C earphones in premium packaging.",
  },
  {
    q: "Is Cash on Delivery (COD) available?",
    a: "No, Cash on Delivery is not available. All orders must be paid online at checkout.",
  },
  {
    q: "Are they comfortable to wear?",
    a: "Yes. Their lightweight open-ear design sits naturally in your ears and stays comfortable even during long listening sessions.",
  },
  {
    q: "What if I receive a damaged product?",
    a: "Contact us within 48 hours of delivery with photos or videos, and we’ll help resolve the issue quickly.",
  },
];
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-hero">
        <div className="mx-auto max-w-7xl px-6 pt-20 pb-8 text-center">
          <p className="text-xs uppercase tracking-[0.4em] text-muted-foreground mb-6 animate-fade-up">
            Introducing
          </p>
          <h1
            className="text-6xl md:text-8xl font-semibold tracking-tighter animate-fade-up"
          ...
          >
            ...
            <Link
              to="/technology"
              className="px-7 py-3.5 rounded-full border border-border text-sm font-medium hover:bg-accent transition flex items-center gap-2"
            >
          ...
          <div
            className="mt-14 grid grid-cols-2 md:grid-cols-3 gap-8 max-w-3xl mx-auto animate-fade-up"
            style={{ animationDelay: "0.2s" }}
          >
            <div>
              <div className="text-4xl md:text-5xl font-semibold tracking-tight text-chrome">
                103<span className="text-2xl align-top">±3</span>dB
              </div>
            ...
            <div>
              <div className="text-4xl md:text-5xl font-semibold tracking-tight text-chrome">
                20<span className="text-2xl">–</span>20kHz
              </div>
              <p className="mt-2 text-xs uppercase tracking-widest text-muted-foreground">
                Frequency response
              </p>
        ...
        <div className="relative -mb-16 px-6 pb-0 md:-mb-24 glow-stage">
          <img
            src={hero}
            alt="Chrome Earphones"
            className="relative mx-auto max-w-4xl w-full object-contain animate-float drop-shadow-[0_50px_70px_rgba(0,0,0,0.45)]"
            width={1920}
            height={1080}
          />
        </div>
      ...
      */}
        ...
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-6 text-5xl md:text-6xl font-semibold tracking-tight">
              Built to move <span className="text-foreground/80">different.</span>
            </h2>
            <p className="mt-6 text-lg md:text-xl text-muted-foreground">
              Striking design. Powerful sound. Zero compromise.
            </p>
          </div>
          <div className="mt-10 grid gap-10 md:grid-cols-3">
            {[
              {
                img: a,
                title: "Own the Look. Hear the Difference.",
                text: "Choose your Chrome Earphones and enjoy bold design with clear, immersive sound built for music, calls, and everyday listening.",
              },
              {
                img: single,
                title: "Discover What Shines Inside.",
                text: "Open the box to reveal your Chrome Earphones, a polished mirror-chrome design that looks modern, feels premium, and is made to stand out.",
              },
              {
                img: b,
                title: "Style Meets Sound.",
                text: "Chrome Earphones combine a premium mirror finish with clear, balanced audio, giving you an everyday listening experience that looks as good as it sounds.",
              },
            ].map((item) => (
      ...
      <section className="bg-card border-y border-border">
        <div className="mx-auto max-w-7xl px-6 py-24 grid md:grid-cols-2 gap-12 items-center">
          <div className="relative glow-stage aspect-square flex items-center justify-center">
            <img
              src={jack}
              alt="Chrome earbud with 3.5mm jack and braided cable"
              loading="lazy"
              className="w-[92%] object-contain animate-float drop-shadow-[0_40px_50px_rgba(0,0,0,0.4)]"
            />
          </div>
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">
            ...
            <h2 className="text-4xl md:text-5xl font-semibold tracking-tight mt-3">
              Pure signal, head to plug
            </h2>
            <p className="mt-5 text-muted-foreground text-lg leading-relaxed">
              Mirror-Finish Design. Crafted with a polished chrome exterior that reflects light
              beautifully and delivers a bold, premium look. Experience crisp vocals, deep bass, and
              crystal-clear sound that brings your music, movies, and calls to life.Connect through
              Type-C and enjoy seamless audio with no charging, pairing, or interruptions.
            </p>
            <Link
              to="/technology"
              className="mt-8 inline-flex items-center gap-2 text-sm font-medium hover:underline"
            >
              Explore the Chrome Earphones
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 grid md:grid-cols-2 gap-10 items-center">
        <div className="order-2 md:order-1">
          ...
          <p className="mt-5 text-muted-foreground text-lg leading-relaxed">
            Clear vocals, deep bass, and balanced audio designed for music, calls, and everything in
            between.
          </p>
          <Link
            to="/chrome"
            className="mt-8 inline-block px-7 py-3.5 rounded-full bg-primary text-primary-foreground text-sm font-medium hover:opacity-90 transition"
          >
            Shop GoChrome
          </Link>
        </div>
        <div className="order-1 md:order-2">
          <img
            src={lifestyle}
            alt="Listener wearing GoChrome earphones"
            loading="lazy"
      ...
      <section className="mx-auto max-w-3xl px-6 py-32">
        ...
        <h2 className="mt-3 text-4xl md:text-6xl font-semibold tracking-tight text-center">
          Frequently asked.
        </h2>
      ...
      <section className="bg-hero">
        <div className="mx-auto max-w-4xl px-6 py-32 text-center">
          ...
          <Link
            to="/chrome"
            className="mt-8 inline-flex items-center gap-2 px-8 py-4 rounded-full bg-primary text-primary-foreground font-medium hover:opacity-90"
          >
