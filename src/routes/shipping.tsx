  ...
  component: () => (
    <>
      ...
      <Prose>
        ...
        <p>
          Most orders are processed and shipped on the same day they are placed. In some cases,
        ...
        <p>
          Once your order is shipped, you will receive a tracking link via SMS or email so you can
        ...
        <p>
          ...
          moment the sealed package is opened until the product is fully inspected.
        </p>
        <p>
          Claims submitted without a valid unboxing video will not be accepted under any
          circumstances, including cases of damaged or defective items.
        </p>
        <p>
        ...
        <p>
          To initiate a return or refund, email us at gochromeaudio@gmail.com with the following
          details:
        </p>
        ...
        <p>
          Once we receive and inspect the returned product, your refund will be processed within 5-7
          business days to your original payment method.
        </p>
        <p>
          For Cash on Delivery (COD) orders, refunds will be sent to your bank account or UPI ID.
        </p>
